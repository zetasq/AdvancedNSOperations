...
class GetEarthquakesOperation: GroupOperation {
  ...
  init(context: NSManagedObjectContext, completionHandler: @escaping () -> Void) {
    ...
    fileprivate func produceAlert(_ error: Error) {
        /*
        ...
        */
        ...
        let errorReason = (error._domain, error._code, error._userInfo?[OperationConditionKey] as? String)
        ...
        switch errorReason {
            case failedReachability:
                ...
                let hostURL = error._userInfo![ReachabilityCondition.hostKey] as! URL
