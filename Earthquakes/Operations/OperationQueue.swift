...
@objc protocol OperationQueueDelegate: NSObjectProtocol {
    @objc optional func operationQueue(_ operationQueue: APPLOperationQueue, willAddOperation operation: Foundation.Operation)
    @objc optional func operationQueue(_ operationQueue: APPLOperationQueue, operationDidFinish operation: Foundation.Operation, withErrors errors: [Error])
}
...
*/
class APPLOperationQueue: Foundation.OperationQueue {
    weak var delegate: OperationQueueDelegate?
    
    override func addOperation(_ operation: Operation) {
        if let op = operation as? APPLOperation {
            ...
            */
            ...
            if !concurrencyCategories.isEmpty {
                ...
                op.addObserver(BlockObserver.init { operation, _ in
