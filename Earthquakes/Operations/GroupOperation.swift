...
*/
class GroupOperation: APPLOperation {
    fileprivate let internalQueue = APPLOperationQueue()
    ...
    */
    ...
    func operationDidFinish(_ operation: Foundation.Operation, withErrors errors: [Error]) {
        // For use by subclassers.
    }
}

extension GroupOperation: OperationQueueDelegate {
    final func operationQueue(_ operationQueue: APPLOperationQueue, willAddOperation operation: Foundation.Operation) {
    ...
    final func operationQueue(_ operationQueue: APPLOperationQueue, operationDidFinish operation: Foundation.Operation, withErrors errors: [Error]) {
